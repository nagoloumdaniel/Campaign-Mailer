...
- **Étape actuelle : bêta, maintenue volontairement (décision du propriétaire, 22 septembre 2026).** L'application est en ligne et utilisée par des bêta-testeurs ; les changements du 22 septembre ont été vérifiés en production. Le projet reste en bêta jusqu'à nouvel ordre : pas de lancement public, pas de nouvelle phase ni de lot de la Phase 9 sans demande explicite du propriétaire. Seuls les demandes du propriétaire et les correctifs sont traités.
