...
export function Footer({ className = '' }: { className?: string }) {
  return (
    <footer className={`border-t border-border ${className}`}>
      <div className="mx-auto flex max-w-6xl flex-col gap-2 px-5 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:py-4">
        <div className="flex items-center gap-2.5">
          ...
          <p className="text-[13px] text-ink-muted">
            ...
            {/* Dropped on a phone, where it wraps the line and costs a row. */}
